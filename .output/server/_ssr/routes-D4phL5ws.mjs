...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D4phL5ws.js
var import_jsx_runtime = require_jsx_runtime();
var logoSources = {
	mark: baytech_logo_mark_default,
	wordmark: baytech_logo_default
};
function renderBaytechLogo({ variant = "wordmark", className = "", label = "Baytech Logo", decorative = false } = {}) {
