...
//#region node_modules/.nitro/vite/services/ssr/assets/gpu-cloud-QuOvCBqZ.js
...
var gpuSystems = [
	{
		...
		specs: [
			{
				label: "CPU",
				value: "Intel 8468 48C 2.1GHz * 2"
			},
			{
				label: "Mem",
				value: "64GB 4800MHz * 32"
			},
			{
				label: "Data",
				value: "3.84TB * 2"
	...
	},
	{
		...
		specs: [
			{
				label: "CPU",
				value: "Intel 8558 48C 2.1GHz * 2"
			},
			{
				label: "Mem",
				value: "64GB 5600MHz * 32"
			},
			{
				label: "Data",
				value: "3.84TB * 4"
	...
	},
	{
		...
		specs: [
			{
				label: "CPU",
				value: "Intel 6960P 72C 2.7GHz * 2"
			},
			{
				label: "Mem",
				value: "128GB 6400MHz * 16"
			},
			{
				label: "Data",
				value: "3.84TB * 8"
	...
	},
	{
		...
		specs: [
			{
				label: "CPU",
				value: "Intel 6776P 64C 2.3GHz"
			},
			{
				label: "Mem",
				value: "96GB 6400MHz * 32"
			},
			{
				label: "Data",
				value: "3.84TB * 8"
	...
	},
	{
		...
		specs: [
			{
				label: "CPU",
				value: "EPYC 9575F 64C 3.3GHz"
			},
			{
				label: "Mem",
				value: "128GB 64MHz * 24"
			},
			{
				label: "Data",
				value: "3.84TB * 3"
	...
	},
	{
		...
		specs: [
			{
				label: "CPU",
				value: "Intel 6740P 48C 2.1GHz"
			},
			{
				label: "Mem",
				value: "64GB 5600MHz * 16"
			},
			{
				label: "Data",
				value: "3.84TB * 8"
...
function renderSpec(spec) {
    ...
    <div class="gpu-system-spec">
      <dt>${specLabels[spec.label] || spec.label}</dt>
      <dd>${spec.value}</dd>
    </div>
  `;
}
function renderWorkloadTags(workloads) {
	return workloads.map((workload) => `<span class="gpu-system-workload-tag">${workload}</span>`).join("");
}
...
function GpuCloudRoute() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LegacyPage, {
		pageKey: "gpu-cloud",
		render: renderGpuCloud
	});
}
//#endregion
export { GpuCloudRoute as component };
